...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMessageThread(int userId, int recipientId)
        {
            ...
            var messageToReturn = this.mapper.Map<IEnumerable<MessageToReturnDto>>(messageFromRepo);
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, [FromQuery]MessageParams messageParams)
        {
            ...
            Response.AddPaginiation(messagesFromRepo.CurrentPage, messagesFromRepo.PageSize, messagesFromRepo.TotalCount, messagesFromRepo.TotalPages);
        ...
        public async Task<IActionResult> CreateMessage(int userId, MessageForCreationDto messageForCreationDto)
        {
            ...
            throw new Exception("Faild to create on save");
        }
        ...
        public async Task<IActionResult> DeleteMessage(int id, int userId)
        {
            ...
            throw new Exception("Error occured when deleting the message");
        }
        ...
        public async Task<IActionResult> MarkMessageAsRead(int id, int userId)
        {
            ...
            throw new Exception("Error occured when opening a message");
        }
    }
}